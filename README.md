# 🛡️ Hebert Lopes | Portfólio de Cibersegurança

🔹 **Especialista em Offensive Security**

## 📌 Sobre Mim

Olá! Sou **Hebert Lopes**, um profissional apaixonado por cibersegurança com foco em **Offensive Security**. Com experiência em auditorias de segurança cibernética, identificação de vulnerabilidades e simulação de ataques, minha jornada é dedicada a explorar e mitigar riscos digitais. Este portfólio destaca minhas habilidades, certificações e projetos na área, com o objetivo de fortalecer a segurança digital através de uma abordagem proativa e ofensiva.
...
### **Pentester** (2021 - Atualmente)
*Intrusion Cyber Security*
*   Condução de auditorias de segurança cibernética abrangentes em redes corporativas, sistemas web e aplicativos móveis.
*   Identificação de vulnerabilidades e ameaças potenciais nos sistemas testados.
*   Utilização de técnicas e ferramentas para a realização de Pentest e engenharia social para simular ataques de phishing, invasões de rede e exploração de vulnerabilidades.
*   Produção de relatórios técnicos detalhados para rápida identificação das vulnerabilidades.
*   Consultoria e orientação para equipes de TI, resultando na descoberta e correção de mais de 100 falhas críticas de segurança.
*   Investigação de incidentes de segurança, incluindo vazamentos de dados e violações de segurança, utilizando técnicas forenses digitais.
*   Colaboração com equipes multifuncionais para implementar medidas de segurança proativas, reduzindo significativamente o risco de exploração de vulnerabilidades.
*   Realização de avaliações de risco de segurança cibernética e fornecimento de recomendações estratégicas para melhorar a postura geral de segurança cibernética da empresa.

### **Assistente de Tecnologia** (2020 - 2021)
*POP Internet*
*   Gestão de projetos de instalação de fibras óticas.
*   Garantia do funcionamento da rede e implementação de melhorias nos processos de cadastro e instalação de clientes.
*   Conhecimento em redes DNS, autenticação, rede fibra GPON, FTTH.
*   Análise de tráfego e monitoramento de links, suporte e manutenção para roteadores.

### **Analista de TI** (2018 - 2022)
*G44 Brasil*
*   Orçamentos de computadores e serviços tecnológicos.
*   Manutenção de computadores e implementação de rotinas de segurança (software Watchguard).
*   Gerenciamento de usuários no ambiente Windows Server e suporte Help Desk.

## 🎓 Educação

**Tecnólogo em Gestão da Tecnologia da Informação**
*Centro Universitário Estácio de Ribeirão Preto*
*Conclusão: Junho de 2015*
...
- **Hack The Box (HTB):** Foco em exploração de máquinas Linux/Windows e desafios de infraestrutura.
- **TryHackMe (THM):** Aprendizado guiado em caminhos de Offensive Security e Red Teaming.
- **PortSwigger Web Security Academy:** Especialização em vulnerabilidades web e exploração avançada com Burp Suite.

### **Referências & Comunidades de Cibersegurança**

Além das plataformas acima, acompanho e utilizo as seguintes referências globais para atualização técnica e metodológica:

- **OffSec (Offensive Security):** Referência mundial em treinamentos práticos e certificações como OSCP.
- **OWASP Foundation:** Guia para segurança de aplicações web (Top 10) e metodologias de teste.
- **MITRE ATT&CK:** Framework para entender táticas e técnicas de adversários em ataques reais.
- **VulnHub:** Laboratórios offline para prática de pentest e engenharia reversa.
- **SANS Institute:** Referência em pesquisa e treinamentos avançados de segurança da informação.

## 🛠️ Projetos e Serviços Realizados
...
- [LinkedIn](https://www.linkedin.com/in/hebertlopes/)
- [YouTube](https://www.youtube.com/@hebertlopes1)
- [Instagram](https://www.instagram.com/hebert_lopes/)
- [X (Twitter)](https://x.com/Hebert_lopes1)

🚀 **Este portfólio está em constante atualização, refletindo meu aprendizado e crescimento contínuo na área de cibersegurança!**
